  ...
  function (_HTMLElement) {
    ...
    _createClass(myCard, [{
      ...
      value: function render() {
        ...
        root(_templateObject(), data.magic, classlang, data.imgsrc, data.title, baseSvg + "solid/tags.svg", data.tags, data.List.map(function (l) {
          return " <a href=\"#\" lang=\"".concat(baseLang, "\" aria-label=\"").concat(l.tagLabel, "\">").concat(l.tag, "</a>,");
