...
*/var Cb=/*#__PURE__*/function(a){function b(){var a,c;e(this,b);for(var d=arguments.length,f=Array(d),g=0;g<d;g++)f[g]=arguments[g];var h=c=p(this,(a=i(b)).call.apply(a,[this].concat(f)));h.render=h.render.bind(h),h.onclick=h.onclick.bind(h),h.getMessages=h.getMessages.bind(h);var j=h.getAttribute("messagesPath"),k=document.documentElement.lang;return h.baseId=h.getAttribute("id"),h.baseSvg=j,h.base=h.urlMessages(j,k),h.baseCss=h.getAttribute("cssPath"),c}return h(b,a),g(b,null,[{key:"observedAttributes",// Retrieve id of the webcomponent
...
this.render()}}},{key:"connectedCallback",value:function(){this.SD=this.attachShadow({mode:"open"}),this.root=Ab(this.SD),this.getMessages()}/**
     ...
     */},{key:"getMessages",value:function(){var a=d(/*#__PURE__*/regeneratorRuntime.mark(function a(){var b,c;return regeneratorRuntime.wrap(function(a){for(;;)switch(a.prev=a.next){case 0:return a.prev=0,a.next=3,fetch("".concat(this.base,"/messages.json"));case 3:return b=a.sent,a.next=6,b.json();case 6:c=a.sent,this.data=c,this.render(),a.next=14;break;case 11:a.prev=11,a.t0=a["catch"](0),console.error(a.t0);case 14:case"end":return a.stop();}},a,this,[[0,11]])}));return function(){return a.apply(this,arguments)}}()},{key:"render",value:function(){var a=this.baseSvg,b=this.baseCss,c=this.data,d=this.onclick,e=this.root;// exit early if no data is present
if(c){/**
       * build the import style tag into the Shadow DOM and append it to the ShadowDOM
       */var f=document.createElement("link"),g="".concat(b)+"/my-card.css";f.href=g.toString(),f.rel="preload",f.as="style",f.toString();var h=document.createElement("style");h.lang="css",h.innerHTML="@import '"+"".concat(b)+"/my-card.css';",h.toString(),e(Bb(),c.magic,c.imgsrc,c.linkMenu1.id,c.linkMenu1.cssClass,c.linkMenu1.link,c.linkMenu1.label,c.linkMenu1.label,a+c.linkMenu1.glyphicon,c.linkMenu1.iconColor,c.linkMenu2.id,c.linkMenu2.cssClass,c.linkMenu2.link,c.linkMenu2.label,c.linkMenu2.label,a+c.linkMenu2.glyphicon,c.linkMenu2.iconColor,c.linkMenu3.id,c.linkMenu3.cssClass,c.linkMenu3.link,c.linkMenu3.label,c.linkMenu3.label,a+c.linkMenu3.glyphicon,c.linkMenu3.iconColor,d,a+"solid/ellipsis-v.svg",a+"solid/tags.svg",c.List.map(function(a){return" <a href=\"javascript:void(0);\">".concat(a.tag,"</a> -")}),c.time,c.title,c.paragraphs.map(function(a){return"<p>".concat(a.para,"</p>")}),c.button1.link,c.button1.cssClass,c.button1.label,c.button1.name,a+c.button1.glyphicon,c.button1.iconColor,c.button2.link,c.button2.cssClass,c.button2.label,c.button2.name,a+c.button2.glyphicon,c.button2.iconColor).appendChild(f).appendChild(h)}}}]),b}(n(HTMLElement));/**
