...
if(c){/**
       ...
       */var f=document.createElement("link"),g="".concat(b)+"/my-card.css";f.href=g.toString(),f.rel="preload",f.as="style",f.toString();var h=document.createElement("style");h.lang="css",h.innerHTML="@import '"+"".concat(b)+"/my-card.css';",h.toString(),e(Bb(),c.magic,c.imgsrc,c.title,a+"solid/tags.svg",c.List.map(function(a){return" <a href=\"javascript:void(0);\">".concat(a.tag,"</a> -")}),c.time,c.linkMenu1.id,c.linkMenu1.cssClass,c.linkMenu1.link,c.linkMenu1.label,c.linkMenu1.label,a+c.linkMenu1.glyphicon,c.linkMenu1.iconColor,c.linkMenu2.id,c.linkMenu2.cssClass,c.linkMenu2.link,c.linkMenu2.label,c.linkMenu2.label,a+c.linkMenu2.glyphicon,c.linkMenu2.iconColor,c.linkMenu3.id,c.linkMenu3.cssClass,c.linkMenu3.link,c.linkMenu3.label,c.linkMenu3.label,a+c.linkMenu3.glyphicon,c.linkMenu3.iconColor,d,a+"solid/ellipsis-v.svg",c.paragraphs.map(function(a){return"<p>".concat(a.para,"</p>")}),c.button1.link,c.button1.cssClass,c.button1.label,c.button1.name,a+c.button1.glyphicon,c.button1.iconColor,c.button2.link,c.button2.cssClass,c.button2.label,c.button2.name,a+c.button2.glyphicon,c.button2.iconColor).appendChild(f).appendChild(h)}}}]),b}(n(HTMLElement));/**
